...
Express backend server for the Vidrune video indexing platform, handling Walrus storage, Polygon smart contracts, and MeiliSearch operations.
...
│   │   ├── contracts.ts       # Polygon contract interactions
...
- **viem**: Ethereum library for Polygon contracts
